...
const ConfirmBooking = React.lazy(() =>
	import("../pages/userPages/ConfirmBooking")
)
...
const DoctorProfile = React.lazy(() =>
	import("../pages/userPages/DoctorProfile")
)
...
const UserAppointments = React.lazy(() =>
	import("../pages/userPages/userAppointments")
)
const UserDoctorPage = React.lazy(() =>
	import("../pages/userPages/UserDoctorPage")
)
const UserPrescriptions = React.lazy(() =>
	import("../pages/userPages/UserPrescriptions")
)
